    ...
    <div class="py-4 admin-page-info">
        ...
        <div class="table-settings mb-4">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col-9 col-lg-8 d-md-flex">
                    <form action="{{ route('admin.subscriber.search') }}" method="POST" class="input-group me-2 me-lg-3 fmxw-400">
                        ...
                        placeholder="Search subscribers by email"  value='{{ Request::input('search') }}' autocomplete="off" maxlength="55" required/>
                        @error('search')
                        ...
                        <div class="btn-group">
                            <div class="dropdown me-1">
                                ...
                                <div class="dynamic-pagination dropdown-menu dropdown-menu-end pb-0">
                                    ...
                                    <a class="dropdown-item {{ Request::is('*/perPage/10') ? 'active' : '' }} {{ Request::is('admin/subscriber') ? 'active' : '' }}"
                                        href="{{ route('admin.subscriber.perPage', 10) }}"> 10 </a>
                                    <a class="dropdown-item {{ Request::is('*/perPage/30') ? 'active' : '' }}"
                                        href="{{ route('admin.subscriber.perPage', 30) }}"> 30 </a>
                                    <a class="dropdown-item {{ Request::is('*/perPage/50') ? 'active' : '' }}"
                                        href="{{ route('admin.subscriber.perPage', 50) }}"> 50 </a>
                                    <a class="dropdown-item {{ Request::is('*/perPage/100') ? 'active' : '' }}"
                                        href="{{ route('admin.subscriber.perPage', 100) }}"> 100 </a>
        ...
        @else
            ...
            <div class="card card-body shadow border-0 table-wrapper table-responsive">
                ...
                <!----------- multi Action ------------->
                <form id="multi-action-form" action="{{ route("admin.subscriber.multiAction") }}" method="POST">
                    <div class="pb-3">
                    ...
                    <table class="table subscriber-table table-hover align-items-center index-table">
                        <thead>
                            <tr>
                                ...
                                <th class="border-bottom">Joined Date</th>
                        ...
                        <tbody>
                            @foreach ($subscribers as $subscriber)
                                <tr>
                                    <td>
                                        <div class="form-check dashboard-check">
                                            <input name="id[]" value="{{ $subscriber->id }}" class="form-check-input checkbox-head check-item"  type="checkbox">
                                            <label class="form-check-label" for="userCheck55">  </label>
                                        </div>
                                    </td>
                                    ...
                                    <td class="actions">
                                        ...
                                        <a href="{{ route('admin.subscriber.destroy', $subscriber->id) }}" class="text-info delete-record">
                    ...
                    <div
                        ...
                        <div class="fw-normal small mt-4 mt-lg-0">
                            Showing <b>{{ $subscribers->firstItem() }}</b> to <b>{{ $subscribers->lastItem() }}</b>
                            of total <b>{{ $subscribers->total() }}</b> entries
                        </div>
                    </div>
                </form>
            </div>

                            ...
                            <div class="card-header">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col text-end">
                                        ...
                                        <a href="{{ route('admin.order.destroy', $order->id) }}" class="btn btn-sm btn-danger delete-record">
                            ...
                            <div class="table-responsive">
                                <table class="table align-items-center table-flush show-data">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="text-capitalize"> <i class="fa-solid fa-gift"></i> Offer </td>
                                            <td> {{ $order->offer->title != "" ? $order->offer->title : '-'  }} </td>
                                        </tr>
                                        <tr>

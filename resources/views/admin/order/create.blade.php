                                ...
                                <div class="row align-items-center">
                                    <form action="{{ route('admin.order.store') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-4 input-content">
                                            ...
                                            <input type="text" name="username" id="username" class="form-control @error('username') is-invalid @enderror" value="{{ old('username') }}" aria-describedby="emailHelp" placeholder="Type Username..." autocomplete="nope" />
                                            @error('username')
                                        ...
                                        <div class="mb-4 input-content">
                                            ...
                                            <select class="form-select form-control @error('offer_id') is-invalid @enderror" name="offer_id" id="offer_id"  aria-label="Default select example" >
                                                ...
                                                @foreach ( $offers as $offer )
                                                    <option value="{{ $offer->id }}"  {{ old('offer_id') == $offer->id ? "selected" : "" }} >{{ $offer->title }}</option>
                                                @endforeach
                                            </select>
                                            @error('offer_id')
                                                <small class="form-text text-danger">{{ $message }}</small>
                                        ...
                                        <div class="mb-4 input-content">
                                            ...
                                            <input type="text" name="email" id="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email') }}" aria-describedby="emailHelp" placeholder="Type Email Address..." autocomplete="nope" />
                                            @error('email')
                                                <small class="form-text text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-4 input-content">
                                            ...
                                            <input type="text" name="phone" id="phone" class="form-control @error('phone') is-invalid @enderror" value="{{ old('phone') }}" aria-describedby="emailHelp" placeholder="Type Phone Number..." autocomplete="nope" />
                                            @error('phone')
                                                <small class="form-text text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>

                ...
                <div class="row">
                    <div class="col-12 mb-4">
                        <div class="card border-0 shadow">
                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <form action="{{ route('admin.responsibility.store') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-4 input-content">
                                            ...
                                            <input type="text" name="title" id="title" class="form-control @error('title') is-invalid @enderror" value="{{ old('title') }}" aria-describedby="emailHelp" placeholder="Type Responsibility Title..." autocomplete="nope" />
                                            @error('title')
                                        ...
                                        <div class="mb-4 input-content">
                                            ...
                                            <textarea type="text" name="summary" rows="5" class="form-control @error('summary') is-invalid @enderror" aria-describedby="emailHelp" placeholder="Type Responsibility Summary..." autocomplete="nope" >{{ old('summary') }}</textarea>
                                            @error('summary')
                                                <small class="form-text text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-4 input-content">
                                            ...
                                            <textarea type="text" name="content" rows="5" class="ckeditor form-control @error('content') is-invalid @enderror" aria-describedby="emailHelp" placeholder="Type Responsibility Content..." autocomplete="nope" >{{ old('content') }}</textarea>
                                            @error('content')
                                                <small class="form-text text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>

                                ...
                                <div class="row align-items-center">
                                    <form action="{{ route('admin.offer.store') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-4 input-content">
                                            ...
                                            <input type="text" name="title" id="title" class="form-control @error('title') is-invalid @enderror" value="{{ old('title') }}" aria-describedby="emailHelp" placeholder="Type Offer Title..." autocomplete="nope" />
                                            @error('title')
                                        ...
                                        <div class="mb-4 input-content">
                                            ...
                                            <textarea type="text" name="summary" rows="5" class="form-control @error('summary') is-invalid @enderror" aria-describedby="emailHelp" placeholder="Type Offer Summary..." autocomplete="nope" >{{ old('summary') }}</textarea>
                                            @error('summary')
                                                <small class="form-text text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-4 input-content">
                                            ...
                                            <textarea type="text" name="content" rows="5" class="ckeditor form-control @error('content') is-invalid @enderror" aria-describedby="emailHelp" placeholder="Type Offer Content..." autocomplete="nope" >{{ old('content') }}</textarea>
                                            @error('content')
                                                <small class="form-text text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>

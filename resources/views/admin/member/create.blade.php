                                ...
                                <div class="row align-items-center">
                                    <form action="{{ route('admin.member.store') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-4 input-content">
                                            ...
                                            <input type="text" name="twitter" id="twitter" class="form-control @error('twitter') is-invalid @enderror" value="{{ old('twitter') }}" aria-describedby="emailHelp" placeholder="Type Member Twitter Link..." autocomplete="nope" />
                                            @error('twitter')
                                                <small class="form-text text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
